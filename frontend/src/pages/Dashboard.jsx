          ...
          {loading ? (
            ...
            teamRanking.members.map((member) => (
              <Card key={member.id} className="!p-3">
                ...
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center gap-2">
                    <span className="font-semibold text-sm dark:text-gray-100">{member.full_name}</span>
                    <span className={`text-xs px-1.5 py-0.5 rounded ${getRoleBadgeClass(member.role)}`}>
                      {getRoleLabel(member.role)}
                    </span>
                  </div>
                  <div className="flex items-center gap-3 text-xs">
                    <span className="text-gray-500 dark:text-gray-400">출석 {member.week_attendance_rate}%</span>
                  </div>
                </div>
                {/* 통계 (한 줄) */}
                <div className="grid grid-cols-5 gap-2 text-xs">
                  ...
                  <div className="text-center p-2 bg-gray-50 dark:bg-gray-700/50 rounded">
                    <p className="text-gray-500 dark:text-gray-400">거래</p>
                    <p className="font-semibold dark:text-gray-200">{member.total_trades || 0}</p>
                  </div>
                  <div className="text-center p-2 bg-gray-50 dark:bg-gray-700/50 rounded">
                  ...
                  <div className="text-center p-2 bg-gray-50 dark:bg-gray-700/50 rounded">
                    <p className="text-gray-500 dark:text-gray-400">포지션</p>
                    <p className="font-semibold dark:text-gray-200">{member.open_positions || 0}</p>
                  </div>
                </div>
              </Card>
            ))
