...
class NewsCrawler:
    ...
    KEYWORDS = {
        ...
        # AI/반도체 (핫섹터)
        "ai_semi": [
            "AI 반도체", "HBM", "GPU", "AI 에이전트", "AI 서버",
            "오픈AI", "딥시크", "DeepSeek", "ChatGPT", "클로드",
            "파운드리", "TSMC", "ASML", "EUV", "첨단 패키징",
            "엔비디아", "SK하이닉스", "삼성전자", "AMD", "인텔", "브로드컴",
        ],

        # 전기차/배터리/모빌리티
        "ev_mobility": [
            "테슬라", "전기차", "배터리", "2차전지", "LFP", "전고체",
            "BYD", "자율주행", "로보택시", "FSD",
        ...
        # 에너지/방산/인프라
        "energy_infra": [
            "원전", "SMR", "소형모듈원자로", "태양광", "수소", "풍력",
            "방산", "한화에어로스페이스", "조선", "HD현대",
            "데이터센터", "전력망", "송전",
        ],

        # 매크로/정책
        "macro_policy": [
            "연준", "FOMC", "파월", "금리 인하", "금리 동결",
            "인플레이션", "CPI", "고용지표", "실업률",
            "중국 경기", "엔화", "엔캐리",
            "금투세", "밸류업", "공매도",
        ],
